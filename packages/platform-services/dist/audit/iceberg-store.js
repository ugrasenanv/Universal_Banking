...
exports.IcebergAuditStore = void 0;
/**
...
class IcebergAuditStore {
    ...
    async query(request) {
        ...
        if (filters.customerId) {
            results = results.filter((a) => a.inputFeatures['customerId'] === filters.customerId ||
     ...
     */
    async getPartitions(jurisdiction) {
        const specs = [];
...
exports.IcebergAuditStore = IcebergAuditStore;
//# sourceMappingURL=iceberg-store.js.map