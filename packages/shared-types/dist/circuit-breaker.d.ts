 ...
 */
export type DegradationTier = 'PRIMARY' | 'SECONDARY' | 'RULES_ENGINE' | 'HUMAN_REVIEW' | 'SAFE_DEFAULT';
/** Ordered degradation tiers from highest capability to safest default. */
export declare const DEGRADATION_ORDER: readonly DegradationTier[];
 ...
 */
export declare function getNextDegradationTier(currentTier: DegradationTier): DegradationTier | undefined;
